    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route
            path="quan-ly-ho-khau"
            element={<Navigate to="/admin/quan-ly-cu-tru" replace />}
          />
          <Route
            path="quan-ly-dan-cu"
            element={<Navigate to="/admin/quan-ly-cu-dan" replace />}
          />
        ...
        >
          ...
          <Route path="payment" element={<UserBill />} />
